...
public class LeakyBucket {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (packetDropped) {
                // System.out.println(i + "\t\t" + packetSize + "\t Dropped \t" + sent + "\t" + current_bucket);
                System.out.print("\tPacket dropped!!");
            }
            else {
                // System.out.println(i + "\t\t" + packetSize + "\t\t" + packetSize + "\t" + sent + "\t" + current_bucket);
                System.out.print("\tReceived: " + packetSize);
                System.out.print("\tSent: " + sent);
                System.out.print("\t\tRemaining: " + current_bucket);
            }
        }
